...
ref = r"logs\reference\reference.wav"
...
cv_path = os.path.abspath(r"rvc\models\embedders\contentvec")
spin2_path = os.path.abspath(r"rvc\models\embedders\spin-v2")
...
with torch.no_grad():
    try:
        ...
        os.makedirs(r"logs\reference\contentvec", exist_ok=True)
    ...
    try:
        ...
        os.makedirs(r"logs\reference\spin-v2", exist_ok=True)
